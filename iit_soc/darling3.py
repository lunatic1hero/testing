...
with open(csv_file, "w", newline='', encoding='utf-8') as f:
    fieldnames = ['method', 'path', 'headers', 'body_length', 'num_commas', 'num_hyphens', 'num_brackets', 'has_sql_keywords']
...
print(f"CSV file '{csv_file}' has been successfully created with analyzed HTTP request data.")
